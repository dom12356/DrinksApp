...
namespace DrinksApp.Models
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(s => s.drink.Id == drink.Id && s.ShoppingCartId == ShoppingCartId);
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            return ShoppingCartItems ??
                (ShoppingCartItems =
                _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Include(s => s.drink).ToList());
        }
